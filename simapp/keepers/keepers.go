...
func NewAppKeeper(
	...
	*/
	...
	wasmHooks := ibchooks.NewWasmHooks(&hooksKeeper, nil, simappparams.Bech32MainPrefix)
	...
	icaControllerIBCModule := icacontroller.NewIBCMiddleware(nil, *appKeepers.ICAControllerKeeper)
