...
func NewSimApp(
	...
	// add keepers
	app.AccountKeeper = authkeeper.NewAccountKeeper(appCodec, keys[authtypes.StoreKey], authtypes.ProtoBaseAccount, maccPerms, simappparams.Bech32Prefix, authtypes.NewModuleAddress(govtypes.ModuleName).String())
