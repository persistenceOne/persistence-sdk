...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/persistenceOne/persistence-sdk/v5/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
