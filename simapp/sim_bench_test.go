...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/persistenceone/persistence-sdk/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
