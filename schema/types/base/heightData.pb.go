...
// source: proto/persistence/schema/types/base/v1beta1/heightData.proto
...
func (*heightData) Descriptor() ([]byte, []int) {
	return fileDescriptor_861b392263617f8f, []int{0}
}
...
func init() {
	proto.RegisterType((*heightData)(nil), "persistence.schema.types.base.v1beta1.heightData")
}

func init() {
	proto.RegisterFile("proto/persistence/schema/types/base/v1beta1/heightData.proto", fileDescriptor_861b392263617f8f)
}

var fileDescriptor_861b392263617f8f = []byte{
	...
	0x2f, 0x33, 0x4c, 0x4a, 0x2d, 0x49, 0x34, 0xd4, 0xcf, 0x48, 0xcd, 0x4c, 0xcf, 0x28, 0x71, 0x49,
	...
	0x54, 0x52, 0xa9, 0x0f, 0xb1, 0x30, 0x3d, 0x3f, 0x3d, 0x1f, 0xc1, 0x82, 0x18, 0xa7, 0x94, 0xc1,
	0xc5, 0x85, 0xb0, 0x42, 0x28, 0x8a, 0x8b, 0xb5, 0x2c, 0x31, 0xa7, 0x34, 0x55, 0x82, 0x51, 0x81,
	0x51, 0x83, 0xd3, 0xc9, 0xe5, 0xc4, 0x3d, 0x79, 0x86, 0x5b, 0xf7, 0xe4, 0x6d, 0xd2, 0x33, 0x4b,
	0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0x91, 0x9d, 0xed, 0x9f, 0x97, 0x8a, 0xcc, 0x0d, 0x76,
	0xf1, 0x46, 0xf1, 0x88, 0x9e, 0x07, 0xd8, 0xe0, 0x20, 0x88, 0x91, 0x4e, 0xda, 0x27, 0x1e, 0xc9,
	0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0, 0x91, 0x1c, 0xe3, 0x84, 0xc7, 0x72, 0x0c, 0x17, 0x1e,
	0xcb, 0x31, 0xdc, 0x78, 0x2c, 0xc7, 0x10, 0x25, 0x88, 0xe1, 0xfd, 0x24, 0x36, 0xb0, 0xeb, 0x8c,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x58, 0xe2, 0xfd, 0x88, 0x2c, 0x01, 0x00, 0x00,
}
...
func (m *heightData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Value.Size() > 0 {
		...
		i = encodeVarintHeightData(dAtA, i, uint64(m.Value.Size()))
		i--
		dAtA[i] = 0xa
	}
