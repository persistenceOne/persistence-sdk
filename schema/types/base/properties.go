...
var _ types.Properties = &Properties{}
...
func (properties *Properties) GetPropertyList() []types.Property {
	a := make([]types.Property, len(properties.PropertyList))
	for i, propertyany := range properties.PropertyList {
		prop, ok := propertyany.GetCachedValue().(types.Property)
		if !ok {
			return nil
		}
		a[i] = prop
...
func (x *Properties) Remove(p ...types.Property) types.Properties {
	panic("implement me")
}

func (x *Properties) Mutate(p ...types.Property) types.Properties {
	panic("implement me")
}
