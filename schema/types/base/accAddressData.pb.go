...
// source: proto/persistence/schema/types/base/v1beta1/accAddressData.proto
...
func (*accAddressData) Descriptor() ([]byte, []int) {
	return fileDescriptor_d8fb337fcd46d802, []int{0}
}
...
func init() {
	proto.RegisterType((*accAddressData)(nil), "persistence.schema.types.base.v1beta1.accAddressData")
}

func init() {
	proto.RegisterFile("proto/persistence/schema/types/base/v1beta1/accAddressData.proto", fileDescriptor_d8fb337fcd46d802)
}

var fileDescriptor_d8fb337fcd46d802 = []byte{
	...
	0x2f, 0x33, 0x4c, 0x4a, 0x2d, 0x49, 0x34, 0xd4, 0x4f, 0x4c, 0x4e, 0x76, 0x4c, 0x49, 0x29, 0x4a,
	0x2d, 0x2e, 0x76, 0x49, 0x2c, 0x49, 0xd4, 0x03, 0x6b, 0x15, 0x52, 0x45, 0xd2, 0xab, 0x07, 0xd1,
	...
	0x18, 0xa7, 0x14, 0xcb, 0xc5, 0x87, 0x6a, 0x8d, 0x90, 0x37, 0x17, 0x6b, 0x59, 0x62, 0x4e, 0x69,
	0xaa, 0x04, 0xa3, 0x02, 0xa3, 0x06, 0xa7, 0x93, 0xe9, 0x89, 0x7b, 0xf2, 0x0c, 0xb7, 0xee, 0xc9,
	0xeb, 0xa6, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x27, 0xe7, 0x17, 0xe7,
	0xe6, 0x17, 0x43, 0x29, 0xdd, 0xe2, 0x94, 0x6c, 0x88, 0xeb, 0xf5, 0x1c, 0xe1, 0x26, 0x05, 0x41,
	0xcc, 0x70, 0xd2, 0x3e, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18,
	0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x86, 0x28, 0x41, 0x0c,
	0x7f, 0x27, 0xb1, 0x81, 0x9d, 0x64, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x30, 0xde, 0x36, 0x02,
	0x25, 0x01, 0x00, 0x00,
}
...
func (m accAddressData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Value = github_com_cosmos_cosmos_sdk_types.AccAddress(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
