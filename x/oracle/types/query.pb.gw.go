...
var (
	...
	pattern_Query_QueryRewardPoolBalance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"persistence", "oracle", "v1beta", "reward_pool_funds"}, "", runtime.AssumeColonVerbOpt(false)))
)
