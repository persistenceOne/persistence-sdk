...
func NewQuerier(k Keeper, legacyQuerierCdc *sdkCodec.LegacyAmino) sdk.Querier {
	return func(ctx sdk.Context, path []string, req abciTypes.RequestQuery) (res []byte, err error) {
		switch path[0] {
...
func queryEpochInfos(ctx sdk.Context, req abciTypes.RequestQuery, k Keeper, legacyQuerierCdc *sdkCodec.LegacyAmino) ([]byte, error) {
