...
type LSMDeposit_LSMDepositState int32 // Deprecated: Do not use.
const (
	// no action has been initiated on the deposit
...
type Unbonding_UnbondingState int32 // Deprecated: Do not use.
const (
...
func (Unbonding_UnbondingState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_71a9a61e676043b6, []int{8, 0}
}

type RedelegateTx_RedelegateTxState int32 // Deprecated: Do not use.
const (
	// redelegate txn sent
...
func (RedelegateTx_RedelegateTxState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_71a9a61e676043b6, []int{13, 0}
}
...
type HostChain struct {
	...
	// redemption rate
	CValue cosmossdk_io_math.LegacyDec `protobuf:"bytes,11,opt,name=c_value,json=cValue,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"c_value"`
	// previous redemption rate
	LastCValue cosmossdk_io_math.LegacyDec `protobuf:"bytes,12,opt,name=last_c_value,json=lastCValue,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"last_c_value"`
	...
	AutoCompoundFactor cosmossdk_io_math.LegacyDec `protobuf:"bytes,15,opt,name=auto_compound_factor,json=autoCompoundFactor,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"auto_compound_factor"`
	// host chain flags
...
type HostChainLSParams struct {
	DepositFee    cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=deposit_fee,json=depositFee,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"deposit_fee"`
	RestakeFee    cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=restake_fee,json=restakeFee,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"restake_fee"`
	UnstakeFee    cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=unstake_fee,json=unstakeFee,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"unstake_fee"`
	RedemptionFee cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=redemption_fee,json=redemptionFee,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"redemption_fee"`
	// LSM validator cap
	//  Should be used only when HostChainFlag.Lsm == true, orelse default
	LsmValidatorCap cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=lsm_validator_cap,json=lsmValidatorCap,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"lsm_validator_cap"`
	// LSM bond factor
	//  Should be used only when HostChainFlag.Lsm == true, orelse default
	LsmBondFactor cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=lsm_bond_factor,json=lsmBondFactor,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"lsm_bond_factor"`
	// UndelegateEntries
	...
	RedelegationAcceptableDelta cosmossdk_io_math.Int       `protobuf:"bytes,9,opt,name=redelegation_acceptable_delta,json=redelegationAcceptableDelta,proto3,customtype=cosmossdk.io/math.Int" json:"redelegation_acceptable_delta"`
	UpperCValueLimit            cosmossdk_io_math.LegacyDec `protobuf:"bytes,10,opt,name=upper_c_value_limit,json=upperCValueLimit,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"upper_c_value_limit"`
	LowerCValueLimit            cosmossdk_io_math.LegacyDec `protobuf:"bytes,11,opt,name=lower_c_value_limit,json=lowerCValueLimit,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"lower_c_value_limit"`
}
...
type Validator struct {
	...
	DelegatedAmount cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=delegated_amount,json=delegatedAmount,proto3,customtype=cosmossdk.io/math.Int" json:"delegated_amount"`
	// the validator token exchange rate, total bonded tokens divided by total
	// shares issued
	ExchangeRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=exchange_rate,json=exchangeRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"exchange_rate"`
...
func (*RedelegateTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_71a9a61e676043b6, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*RewardParams)(nil), "pstake.liquidstakeibc.v1beta1.RewardParams")
...
var fileDescriptor_71a9a61e676043b6 = []byte{
	...
	,
}
...
func (m *RewardParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Destination) > 0 {
		...
		i = encodeVarintLiquidstakeibc(dAtA, i, uint64(len(m.Destination)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Denom) > 0 {
...
func (m *HostChainLSParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.LowerCValueLimit.Size()
		i -= size
		if _, err := m.LowerCValueLimit.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintLiquidstakeibc(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x5a
	{
		size := m.UpperCValueLimit.Size()
		i -= size
		if _, err := m.UpperCValueLimit.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintLiquidstakeibc(dAtA, i, uint64(size))
	}
...
func (m *Unbonding) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x22
	n10, err10 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.MatureTime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.MatureTime):])
	if err10 != nil {
		return 0, err10
	}
	i -= n10
	i = encodeVarintLiquidstakeibc(dAtA, i, uint64(n10))
	i--
	dAtA[i] = 0x1a
	if m.EpochNumber != 0 {
...
func (m *ValidatorUnbonding) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n14, err14 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.MatureTime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.MatureTime):])
	if err14 != nil {
		return 0, err14
	}
	i -= n14
	i = encodeVarintLiquidstakeibc(dAtA, i, uint64(n14))
	i--
	dAtA[i] = 0x1a
	if m.EpochNumber != 0 {
		i = encodeVarintLiquidstakeibc(dAtA, i, uint64(m.EpochNumber))
...
func (m *HostChainLSParams) Size() (n int) {
	...
	n += 1 + l + sovLiquidstakeibc(uint64(l))
	l = m.UpperCValueLimit.Size()
	n += 1 + l + sovLiquidstakeibc(uint64(l))
	l = m.LowerCValueLimit.Size()
	n += 1 + l + sovLiquidstakeibc(uint64(l))
	return n
}
...
func (m *HostChainLSParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpperCValueLimit", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.UpperCValueLimit.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LowerCValueLimit", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LowerCValueLimit.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
