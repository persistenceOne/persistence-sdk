...
import (
	...
	types "github.com/persistenceOne/persistence-sdk/v7/x/liquidstakeibc/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type InstantiationState int32 // Deprecated: Do not use.
const (
	// Not Initiated
...
type FeatureType int32 // Deprecated: Do not use.
const (
...
var fileDescriptor_429540018f2469ab = []byte{
	...
	,
}
