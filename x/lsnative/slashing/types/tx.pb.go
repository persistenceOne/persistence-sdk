...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "lsnative.slashing.v1beta1.MsgUnjail")
	proto.RegisterType((*MsgUnjailResponse)(nil), "lsnative.slashing.v1beta1.MsgUnjailResponse")
}
