...
var (
	...
	// ModuleCdc references the global x/halving module codec. Note, the codec should
...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	cdc.RegisterConcrete(&MsgUpdateParams{}, "persistence/halving/MsgUpdateParams", nil)
}
