...
func (transactionRequest transactionRequest) MakeMsg() (sdkTypes.Msg, error) {
	...
	return newMessage(
		...
		base2.NewID(transactionRequest.IdentityID),
...
func newTransactionRequest(baseReq protoTypes.BaseReq, fromID string, identityID string, mutableMetaProperties string, mutableProperties string) helpers.TransactionRequest {
	return transactionRequest{
		BaseReq:               baseReq,
		FromID:                fromID,
