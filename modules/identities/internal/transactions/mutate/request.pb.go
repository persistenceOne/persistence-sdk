...
// source: proto/identities/transactions/mutate/request.proto
...
type transactionRequest struct {
	...
	MutableMetaProperties string             `protobuf:"bytes,4,opt,name=mutableMetaProperties,proto3" json:"mutableMetaProperties,omitempty"  valid:"required~required field mutableMetaProperties missing, matches(^.*$)~invalid field mutableMetaProperties"`
	MutableProperties     string             `protobuf:"bytes,5,opt,name=mutableProperties,proto3" json:"mutableProperties,omitempty"  valid:"required~required field mutableProperties missing, matches(^.*$)~invalid field mutableProperties"`
}
...
func (*transactionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7def99668b2c1f4, []int{0}
}
...
func init() {
	proto.RegisterFile("proto/identities/transactions/mutate/request.proto", fileDescriptor_f7def99668b2c1f4)
}

var fileDescriptor_f7def99668b2c1f4 = []byte{
	// 345 bytes of a gzipped FileDescriptorProto
	,
}
