...
func Test_Define_Request(t *testing.T) {
	...
	require.Equal(t, newMessage(fromAccAddress, testBase.NewID("fromID"), testBase.NewID("identityID"), mutableMetaProperties, mutableProperties), msg)
	require.Nil(t, Error)

	msg, Error = newTransactionRequest(test_types.BaseReq{From: "randomFromAddress", ChainId: "test"}, "fromID", "identityID", mutableMetaPropertiesString, mutablePropertiesString).MakeMsg()
