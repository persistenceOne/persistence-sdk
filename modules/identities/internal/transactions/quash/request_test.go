...
func Test_Quash_Request(t *testing.T) {
	...
	require.Equal(t, transactionRequest{BaseReq: protoTypes.BaseReq{From: cliContext.GetFromAddress().String(), ChainId: cliContext.ChainID, Simulate: cliContext.Simulate}, FromID: "", IdentityID: ""}, requestFromCLI)
	...
	msg2, Error := newTransactionRequest(protoTypes.BaseReq{From: "randomFromAddress", ChainId: "test"}, "fromID", "identityID").MakeMsg()
	require.NotNil(t, Error)
	require.Nil(t, msg2)
