...
// source: proto/identities/transactions/issue/request.proto
...
type transactionRequest struct {
	...
	To                      string             `protobuf:"bytes,2,opt,name=from_iD,json=fromID,proto3" json:"from_iD,omitempty"  valid:"required~required field to missing, matches(^[a-z0-9]+$)~invalid field to"`
	FromID                  string             `protobuf:"bytes,3,opt,name=toID,proto3" json:"toID,omitempty"  valid:"required~required field fromID missing, matches(^[A-Za-z0-9-_=.|]+$)~invalid field fromID "`
	...
	ImmutableMetaProperties string             `protobuf:"bytes,5,opt,name=immutableMetaProperties,proto3" json:"immutableMetaProperties,omitempty"  valid:"required~required field immutableMetaProperties missing, matches(^.*$)~invalid field immutableMetaProperties"`
	ImmutableProperties     string             `protobuf:"bytes,6,opt,name=immutableProperties,proto3" json:"immutableProperties,omitempty"  valid:"required~required field immutableProperties missing, matches(^.*$)~invalid field immutableProperties"`
...
func (*transactionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_06efd4bb459165c3, []int{0}
}
...
func init() {
	proto.RegisterFile("proto/identities/transactions/issue/request.proto", fileDescriptor_06efd4bb459165c3)
}

var fileDescriptor_06efd4bb459165c3 = []byte{
	// 388 bytes of a gzipped FileDescriptorProto
	,
}
