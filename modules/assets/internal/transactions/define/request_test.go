...
func Test_Define_Request(t *testing.T) {
	...
	require.Equal(t, newMessage(fromAccAddress, testBase.NewID("fromID"), immutableMetaProperties, immutableProperties, mutableMetaProperties, mutableProperties), msg)
	require.Nil(t, Error)
