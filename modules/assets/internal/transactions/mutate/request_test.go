...
func Test_Define_Request(t *testing.T) {
	...
	require.Equal(t, newMessage(fromAccAddress, base2.NewID("fromID"), base2.NewID("assetID"), mutableMetaProperties, mutableProperties), msg)
	require.Nil(t, Error)

	msg, Error = newTransactionRequest(protoTypes.BaseReq{From: "randomFromAddress", ChainId: "test"}, "fromID", "assetID", mutableMetaPropertiesString, mutablePropertiesString).MakeMsg()
