...
func newMessage(from sdkTypes.AccAddress, fromID test_types.ID, assetID test_types.ID, mutableMetaProperties types.MetaProperties, mutableProperties types.Properties) sdkTypes.Msg {
	return message{
		From:                  from,
		FromID:                fromID,
		AssetID:               assetID,
