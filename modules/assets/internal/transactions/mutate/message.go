...
func newMessage(from sdkTypes.AccAddress, fromID protoTypes.ID, assetID protoTypes.ID, mutableMetaProperties types.MetaProperties, mutableProperties types.Properties) sdkTypes.Msg {
	return message{
		From:                  from,
		FromID:                fromID,
		AssetID:               assetID,
