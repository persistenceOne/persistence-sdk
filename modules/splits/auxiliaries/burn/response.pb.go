...
// source: proto/persistence/assets/splits/auxiliaries/burn/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*auxiliaryResponse)(nil), "persistence.assets.splits.auxiliaries.burn.v1beta1.auxiliaryResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/splits/auxiliaries/burn/v1beta1/response.proto", fileDescriptor_3d33bd1d9285d074)
}
