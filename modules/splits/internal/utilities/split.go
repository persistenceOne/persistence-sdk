...
func AddSplits(splits helpers.Collection, ownerID protoTypes.ID, ownableID protoTypes.ID, value sdkTypes.Dec) (helpers.Collection, error) {
...
func SubtractSplits(splits helpers.Collection, ownerID protoTypes.ID, ownableID protoTypes.ID, value sdkTypes.Dec) (helpers.Collection, error) {
	if value.LTE(sdkTypes.ZeroDec()) {
		return nil, errors.NotAuthorized
	}
