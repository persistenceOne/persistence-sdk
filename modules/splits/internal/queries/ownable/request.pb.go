...
// source: proto/persistence/modules/splits/queries/ownable/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*queryRequest)(nil), "persistence.modules.splits.queries.ownable.v1beta1.queryRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/splits/queries/ownable/v1beta1/request.proto", fileDescriptor_2ccbfb9712316af5)
}
