...
// source: proto/persistence/modules/splits/queries/split/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*queryResponse)(nil), "persistence.modules.splits.queries.split.v1beta1.queryResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/splits/queries/split/v1beta1/response.proto", fileDescriptor_3c2cedadf96794ce)
}
