...
// source: proto/persistence/assets/splits/transactions/wrap/v1beta1/response.proto
...
func init() {
	proto.RegisterFile("proto/persistence/assets/splits/transactions/wrap/v1beta1/response.proto", fileDescriptor_9782dfbbe5a79684)
}
