...
// source: persistence/modules/splits/transactions/unwrap/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*transactionResponse)(nil), "persistence.modules.splits.transactions.unwrap.v1beta1.transactionResponse")
}

func init() {
	proto.RegisterFile("persistence/modules/splits/transactions/unwrap/v1beta1/response.proto", fileDescriptor_a0619cd869489ec0)
}
