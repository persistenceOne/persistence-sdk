...
// source: proto/persistence/modules/splits/transactions/unwrap/v1beta1/request.proto
...
func init() {
	proto.RegisterFile("proto/persistence/modules/splits/transactions/unwrap/v1beta1/request.proto", fileDescriptor_93a33951dfdbcc05)
}
