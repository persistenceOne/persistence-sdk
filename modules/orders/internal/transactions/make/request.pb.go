...
// source: proto/persistence/assets/orders/transactions/make/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*transactionRequest)(nil), "persistence.assets.orders.transactions.make.v1beta1.transactionRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/orders/transactions/make/v1beta1/request.proto", fileDescriptor_5d9487890a822b1f)
}
