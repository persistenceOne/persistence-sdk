...
// source: proto/persistence/modules/orders/transactions/immediate/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*transactionResponse)(nil), "persistence.modules.orders.transactions.immediate.v1beta1.transactionResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/orders/transactions/immediate/v1beta1/response.proto", fileDescriptor_0c73a7aa3ada50bc)
}
