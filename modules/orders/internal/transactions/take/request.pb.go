...
// source: proto/persistence/assets/orders/transactions/take/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*transactionRequest)(nil), "persistence.assets.orders.transactions.take.v1beta1.transactionRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/orders/transactions/take/v1beta1/request.proto", fileDescriptor_e6c58f69d4378df5)
}
