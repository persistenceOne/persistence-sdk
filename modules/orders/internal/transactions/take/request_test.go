...
func Test_Take_Request(t *testing.T) {
	...
	msg2, Error := newTransactionRequest(rest.BaseReq{From: "randomFromAddress", ChainID: "test"}, "fromID", "3", "orderID").MakeMsg()
	require.NotNil(t, Error)
	require.Nil(t, msg2)

	msg2, Error = newTransactionRequest(testBaseReq, "fromID", "randomString", "orderID").MakeMsg()
	require.NotNil(t, Error)
	require.Nil(t, msg2)
