...
// source: proto/persistence/assets/orders/transactions/revoke/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*transactionRequest)(nil), "persistence.assets.orders.transactions.revoke.v1beta1.transactionRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/orders/transactions/revoke/v1beta1/request.proto", fileDescriptor_d1b56e9b1d7f6e05)
}
