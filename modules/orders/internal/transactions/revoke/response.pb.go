...
// source: proto/persistence/assets/orders/transactions/revoke/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*transactionResponse)(nil), "persistence.assets.orders.transactions.revoke.v1beta1.transactionResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/orders/transactions/revoke/v1beta1/response.proto", fileDescriptor_15d008b79c361b27)
}
