...
// source: proto/persistence/assets/orders/transactions/deputize/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*transactionResponse)(nil), "persistence.assets.orders.transactions.deputize.v1beta1.transactionResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/orders/transactions/deputize/v1beta1/response.proto", fileDescriptor_25a11e62e306dfa4)
}
