...
// source: proto/persistence/modules/orders/transactions/deputize/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*transactionRequest)(nil), "persistence.modules.orders.transactions.deputize.v1beta1.transactionRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/orders/transactions/deputize/v1beta1/request.proto", fileDescriptor_50cd481ba37ed8c1)
}
