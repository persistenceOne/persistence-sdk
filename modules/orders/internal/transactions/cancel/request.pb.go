...
// source: proto/persistence/modules/orders/transactions/cancel/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*transactionRequest)(nil), "persistence.modules.orders.transactions.cancel.v1beta1.transactionRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/orders/transactions/cancel/v1beta1/request.proto", fileDescriptor_8bf8f11d8e270c6e)
}
