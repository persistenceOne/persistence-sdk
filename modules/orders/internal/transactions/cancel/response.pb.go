...
// source: proto/persistence/assets/orders/transactions/cancel/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*transactionResponse)(nil), "persistence.assets.orders.transactions.cancel.v1beta1.transactionResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/orders/transactions/cancel/v1beta1/response.proto", fileDescriptor_afaa7053bd79219b)
}
