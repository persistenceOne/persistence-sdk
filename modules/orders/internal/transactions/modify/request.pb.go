...
// source: proto/persistence/assets/orders/transactions/modify/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*transactionRequest)(nil), "persistence.assets.orders.transactions.modify.v1beta1.transactionRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/orders/transactions/modify/v1beta1/request.proto", fileDescriptor_4b9709ad406c40c8)
}
