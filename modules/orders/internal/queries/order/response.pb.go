...
// source: proto/persistence/modules/orders/queries/orders/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*queryResponse)(nil), "persistence.modules.orders.queries.order.v1beta1.queryResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/orders/queries/orders/v1beta1/response.proto", fileDescriptor_6e675ce6d6798364)
}
