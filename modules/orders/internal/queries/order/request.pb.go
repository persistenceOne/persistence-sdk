...
// source: proto/persistence/assets/orders/queries/orders/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*queryRequest)(nil), "persistence.assets.orders.queries.order.v1beta1.queryRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/orders/queries/orders/v1beta1/request.proto", fileDescriptor_6a3fbca774d96bb4)
}
