...
func (classification classification) GetID() protoTypes.ID { return classification.ID }
...
func NewClassification(id protoTypes.ID, immutableProperties types.Properties, mutableProperties types.Properties) mappables.Classification {
