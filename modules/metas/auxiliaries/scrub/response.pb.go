...
// source: proto/persistence/assets/metas/auxiliaries/scrub/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*auxiliaryResponse)(nil), "persistence.assets.metas.auxiliaries.scrub.v1beta1.auxiliaryResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/metas/auxiliaries/scrub/v1beta1/response.proto", fileDescriptor_d38a3e5e4af85068)
}
