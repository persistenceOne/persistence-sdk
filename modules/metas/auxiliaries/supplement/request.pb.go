...
// source: proto/persistence/assets/metas/auxiliaries/supplement/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*auxiliaryRequest)(nil), "persistence.assets.metas.auxiliaries.supplement.v1beta1.auxiliaryRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/metas/auxiliaries/supplement/v1beta1/request.proto", fileDescriptor_5e6188ae0a861cf7)
}
