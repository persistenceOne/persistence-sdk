...
// source: proto/persistence/modules/metas/transactions/reveal/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*transactionRequest)(nil), "persistence.modules.metas.transactions.reveal.v1beta1.transactionRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/metas/transactions/reveal/v1beta1/request.proto", fileDescriptor_641b8cccb7bc96b3)
}
