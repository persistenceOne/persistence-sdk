...
// source: proto/persistence/assets/maintainers/auxiliaries/revoke/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*auxiliaryRequest)(nil), "persistence.assets.maintainers.auxiliaries.revoke.v1beta1.auxiliaryRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/maintainers/auxiliaries/revoke/v1beta1/request.proto", fileDescriptor_b15ba8bd63bfc50e)
}
