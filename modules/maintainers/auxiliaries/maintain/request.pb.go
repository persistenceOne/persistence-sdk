...
// source: proto/persistence/assets/maintainers/auxiliaries/maintain/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*auxiliaryRequest)(nil), "persistence.assets.maintainers.auxiliaries.maintain.v1beta1.auxiliaryRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/assets/maintainers/auxiliaries/maintain/v1beta1/request.proto", fileDescriptor_9dae68baa1c79cec)
}
