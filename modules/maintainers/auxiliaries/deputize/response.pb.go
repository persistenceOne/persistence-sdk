...
// source: proto/persistence/modules/maintainers/auxiliaries/deputize/v1beta1/response.proto
...
func init() {
	proto.RegisterType((*auxiliaryResponse)(nil), "persistence.modules.maintainers.auxiliaries.deputize.v1beta1.auxiliaryResponse")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/maintainers/auxiliaries/deputize/v1beta1/response.proto", fileDescriptor_ab8ef3b7b14d62cd)
}
