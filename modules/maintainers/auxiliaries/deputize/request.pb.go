...
// source: proto/persistence/modules/maintainers/auxiliaries/deputize/v1beta1/request.proto
...
func init() {
	proto.RegisterType((*auxiliaryRequest)(nil), "persistence.modules.maintainers.auxiliaries.deputize.v1beta1.auxiliaryRequest")
}

func init() {
	proto.RegisterFile("proto/persistence/modules/maintainers/auxiliaries/deputize/v1beta1/request.proto", fileDescriptor_1e088071cb39a9ad)
}
